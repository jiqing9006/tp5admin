...
# Dump of table ylt_admin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_admin`;

CREATE TABLE `ylt_admin` (
...
LOCK TABLES `ylt_admin` WRITE;
/*!40000 ALTER TABLE `ylt_admin` DISABLE KEYS */;

INSERT INTO `ylt_admin` (`id`, `username`, `password`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `mobile`, `realname`, `openid`, `status`, `updatetime`)
VALUES
...
/*!40000 ALTER TABLE `ylt_admin` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ylt_admin_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_admin_group`;

CREATE TABLE `ylt_admin_group` (
...
LOCK TABLES `ylt_admin_group` WRITE;
/*!40000 ALTER TABLE `ylt_admin_group` DISABLE KEYS */;

INSERT INTO `ylt_admin_group` (`id`, `name`, `description`, `rules`, `listorder`, `updatetime`)
VALUES
...
/*!40000 ALTER TABLE `ylt_admin_group` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ylt_admin_group_access
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_admin_group_access`;

CREATE TABLE `ylt_admin_group_access` (
...
LOCK TABLES `ylt_admin_group_access` WRITE;
/*!40000 ALTER TABLE `ylt_admin_group_access` DISABLE KEYS */;

INSERT INTO `ylt_admin_group_access` (`uid`, `group_id`)
VALUES
	(2,1),
	(3,1),
	(3,2),
...
/*!40000 ALTER TABLE `ylt_admin_group_access` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ylt_admin_log
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_admin_log`;

CREATE TABLE `ylt_admin_log` (
...
LOCK TABLES `ylt_admin_log` WRITE;
/*!40000 ALTER TABLE `ylt_admin_log` DISABLE KEYS */;

INSERT INTO `ylt_admin_log` (`id`, `m`, `c`, `a`, `querystring`, `userid`, `username`, `ip`, `time`)
VALUES
	(1,'admin','Group','index','',4,'test',2130706433,0);

/*!40000 ALTER TABLE `ylt_admin_log` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ylt_app
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_app`;

CREATE TABLE `ylt_app` (
...
# Dump of table ylt_config
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_config`;

CREATE TABLE `ylt_config` (
...
# Dump of table ylt_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ylt_menu`;

CREATE TABLE `ylt_menu` (
...
LOCK TABLES `ylt_menu` WRITE;
/*!40000 ALTER TABLE `ylt_menu` DISABLE KEYS */;

INSERT INTO `ylt_menu` (`id`, `name`, `parentid`, `icon`, `c`, `a`, `data`, `tip`, `group`, `listorder`, `display`, `updatetime`)
VALUES
...
/*!40000 ALTER TABLE `ylt_menu` ENABLE KEYS */;
UNLOCK TABLES;
